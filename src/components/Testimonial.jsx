...
export const Testimonial = ({ img, testimonial, name, position }) => {
  return (
    <div className=" flex flex-col items-center text-center mb-[64px]">
      <img className="w-[72px] rounded-full" src={img} alt="picture" />
      <p className="my-8 font-Barlow text-Very-dark-desaturated-blue px-4 max-w-[400px] desktop:my-14">{testimonial}</p>
